...
class AdministratorsControllerTest < ActionController::TestCase
  ...
  test "should create administrator" do
    assert_difference('Administrator.count') do
      post :create, administrator: { full_name: @administrator.full_name, user_name: @administrator.user_name }
    end
  ...
  test "should update administrator" do
    patch :update, id: @administrator, administrator: { full_name: @administrator.full_name, user_name: @administrator.user_name }
    assert_redirected_to administrator_path(assigns(:administrator))
  end
